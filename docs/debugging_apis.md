...
![alt text](./doc-images/debugging_apis.png)

2. Once in CircleCI, make sure you’re viewing the entire workflow for the build by checking the submenu on the left, and making sure the view URL includes workflows in its path i.e.:

   https://app.circleci.com/pipelines/github/LBHackney-IT/person-api
...
![alt text](./doc-images/debugging_apis2.png)
...
- Response structures
  i. Do they match what you expect/the Swagger doc?
  ii. Are there any unexpected duplications?
  iii. Have enums been transformed correctly into strings?
  iv. Do all possible combinations of search parameters work as expected?
   v. Do all possible variations of the limit and cursor parameters work as expected?
...
2. [see related Production testing checklist to complete this section]

## Errors
1. [see related Production testing checklist to complete this section]
